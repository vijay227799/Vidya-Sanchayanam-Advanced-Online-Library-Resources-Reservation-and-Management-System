...
<a href="manage-books.php">
 ...
 <img src="open-book.gif" height="80" width="80">
<?php 
             ...
             <a href="manage-issued-books.php">
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-warning back-widget-set text-center">
                            <img src="book-recommendation.gif" height="80" width="80">
<?php 
  ...
  <a href="reg-students.php">
               <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-danger back-widget-set text-center">
                            <img src="user (1).gif" height="80" width="80">
                            <?php 
...
?>
 ...
 <div class="col-md-3 col-sm-3 col-xs-6">
                      <div class="alert alert-success back-widget-set text-center">
                            <img src = "employee.gif" height="80" width="80">
<?php 
...
<img src="list.gif" height="80" width="80">
<?php 
