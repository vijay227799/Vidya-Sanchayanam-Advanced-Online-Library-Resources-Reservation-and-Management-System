...
<div class="col-md-6">
 <div class="form-group">
 <label>Total Number of Books Available<span style="color:black;">*</span></label>
 <input class="form-control" type="number" name="price" value="<?php echo htmlentities($result->BookPrice);?>" required />
 </div></div>
 <?php }} ?>
<div class="col-md-12">
